...
function StudentList() {
  ...
  <input type="text" class="form-control" placeholder="Type student name to search" />
</p>
<div class="students">
  <div class="row mb-2">
    <div class="col-6">
 ...
 {/* <!-- const clean = (url) => {
    ...
    <div class="col-6 text-right">
      ...
      <a target="_blank" href="" class="btn btn-light ml-2 bd-highlight">
      ...
      <a target="_blank" href='https://github.com/{{members.basic_info.github}}'
        class="btn btn-light ml-2 bd-highlight">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github"
          class="svg-inline--fa fa-github fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
          <path fill="currentColor"
      ...
      <a target="_blank"  href="/details" class="btn btn-light ml-2 bd-highlight text-decoration-none see_more_button">
